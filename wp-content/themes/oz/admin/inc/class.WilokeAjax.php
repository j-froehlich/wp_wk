...
class WilokeAjax
{
    ...
    static public function wiloke_contactform7_demo()
    {
        ...
        if ( isset($wiloke->aConfigs['contactform7'][$_POST['import_of']]) )
        {
            ...
            esc_html_e('There are no contact forms', 'oz');
        }
    ...
    static public function wiloke_loadmore_posts($postType='', $aArgs=array(), $isReturn=false)
    {
        ...
        $args = array(
            'post_types'    => $postType,
            'paged'         => 1,
            'posts_per_page'=> $aArgs['additional']['parse_data']['general_settings']['number_of_posts']
        );
        ...
        $isCropImage = isset($args['is_crop_image']) && $args['is_crop_image'] ? true : false;
