...
class WilokeContactForm
{
    ...
    public function wiloke_enqueue_scripts()
    {
        ...
        wp_enqueue_script('wiloke_contactform7', WILOKE_AD_SOURCE_URI . 'js/contactform7'.$min.'js', array('jquery'), null, true);
    }
    ...
    public function wiloke_contactfom7_helper()
    {
        ...
        <div id="wilokecontactform7" class="contactform7">
            <div class="postbox-container">
                <div class="postbox">
                    <h2 class="hndle"><?php esc_html_e('Contact form 7 Option', 'oz'); ?></h2>
                    <div class="inside">
                        <p><?php esc_html_e('Click Import button make this contact form look like demo.', 'oz'); ?></p>
                        <?php 
                            ...
                            echo '</select>';
                        ?>
                        <button id="wiloke-import-contactform7" class="button button-primary"><?php esc_html__('Import', 'oz'); ?><?php esc_html_e('Import', 'oz'); ?></button>
                    </div>
                </div>
            </div>
        </div>
