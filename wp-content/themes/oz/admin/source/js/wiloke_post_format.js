...
(function($) {
    ...
    $.fn.wilokePostFormatMediaPopup = function (opts) {
        ...
        var $insert = '';
        var WilokePostFormatMediaPopup = {
            $el: $self,
            options: options,
            ...
            createHTML: function () {
                ...
                _this.$showImage = $('.list-wiloke-image-media', $parent);
            },
            events: function () {
                var _this = this;
    ...
    $.fn.wilokePostFormatAudioPopup = function (opts) {
        ...
        var WilokePostFormatAudioPopup = {
            $el: $self,
            options: options,
            audio: null,
            $button: $('.wiloke-button', $self),
            ...
            events: function () {
                ...
                _this.audio.on('select', function () {
                    var selection = _this.audio.state().get('selection');
                    selection.each (function (attachment, id) {
        ...
        var WilokePostFormat = {
            ...
            events: function () {
                ...
                $('li', _this.$controls).click( function (event) {
                    ...
                    var $format = $('#wiloke-post-format-' + format);
                    $format.show();
                ...
                // Gallery
                var $gallery = $('#wiloke-post-format-gallery'),
                ...
                // Video
                var $videoUrl = $('#wiloke-video-field-url')
